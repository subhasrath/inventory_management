...
//File that returns customer Name
customerDetailsCustomerFullNameFile = 'model/customer/showCustomerNames.php';
...
$(document).ready(function(){
	...
	$(document).on('click', '#saleDetailsCustomerIDSuggestionsList li', function(){
		...
		// Added on 17/12/2022
		// Listen to item name text box in item details tab
		$('#customerDetailsCustomerFullName').keyup(function(){
			showSuggestions('customerDetailsCustomerFullName', customerDetailsCustomerFullNameFile, 'customerDetailsCustomerFullNameSuggestionsDiv');
		});
		
		// Remove the item names suggestions dropdown in the item details tab
		// when user selects an item from it
		$(document).on('click', '#customerDetailsCustomerFullNameSuggestionsList li', function(){
			$('#customerDetailsCustomerFullName').val($(this).text());
			$('#customerDetailsCustomerFullNameSuggestionsList').fadeOut();
		});
