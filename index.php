	  ...
	  <div class="row">
		...
		<h1 class="my-4"></h1>
			<div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
			  ...
			  <a  href="invoice/invoice-form-db.php" role="tab">Invoice</a>
					...
					<form>
					  ...
					  <div class="form-row">
						...
						<div class="form-group col-md-2">
						  ...
						  <input type="number" class="form-control" id="saleDetailsUnitPrice" name="saleDetailsUnitPrice" value="">
						</div>
						<div class="form-group col-md-3">
					 ...
					 <form> 
					  <div class="form-row">
						<div class="form-group col-md-6">
						  ...
						  <div id="customerDetailsCustomerFullNameSuggestionsDiv" class="customListDivWidth"></div>
						</div>
						<div class="form-group col-md-2">
					  ...
					  <div class="form-row">
						  ...
						  <div class="form-group col-md-3">
							<label for="customerDetailsCustomerPhone2">GSTIN NO</label>
